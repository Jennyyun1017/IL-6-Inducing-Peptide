...
class Scoring:
    ...
    def optimizeMcc(self, cutOffList=None, method='mcc', bestCutoffJsonPath=None):
        ...
        mccMaxDict = mccMaxSeries.to_dict()
        with open(bestCutoffJsonPath, 'w') as f:
            json.dump(mccMaxDict, f)
        bestPredArrList = []
        ...
        self.predVectorList_cutOff = bestPredArrList    # probability 經過最佳 cutoff 轉出的 0 or 1 vector (binary prediction)

        return bestPredArrList
