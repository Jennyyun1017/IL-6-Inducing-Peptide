...
class EncodeModelAmp:
    ...
    def encode(self):
        ...
        If default = True which will output the # of mark:
            ...
            #Aliphatic_Index : Method to calculate the aliphatic pepName of every sequence in the attribute sequences.
            ...
            #AASI : An amino acid selectivity pepName scale for helical antimicrobial peptides.
            ...
            #MSS : A graph-theoretical pepName that reflects topological shape and size of amino acid side chains.
            ...
            Boman_Index : Method to calculate the boman pepName of every sequence in the attribute sequences.
